...
CREATE TABLE IF NOT EXISTS `canudosway`.`professor` (
  ...
  `curriculo_lattes` VARCHAR(100) NULL,
...
-- -----------------------------------------------------
-- Table `canudosway`.`aluno_turma_disciplina`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `canudosway`.`aluno_turma_disciplina` (
  `id_aluno_turma_disciplina` INT NOT NULL AUTO_INCREMENT,
  `id_aluno` INT NOT NULL,
  `id_turma_disciplina` INT NOT NULL,
  ...
  INDEX `fk_turma_disciplina_idx` (`id_turma_disciplina` ASC),
  CONSTRAINT `fk_aluno`
    FOREIGN KEY (`id_aluno`)
    REFERENCES `canudosway`.`aluno` (`id_aluno`)
    ON DELETE NO ACTION
...
-- -----------------------------------------------------
-- Table `canudosway`.`pre_requisitos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `canudosway`.`pre_requisitos` (
  `id_disciplina` INT NOT NULL,
  `id_disciplina_pre_requisito` INT NOT NULL,
  INDEX `fk_pre_requisitos_1_idx` (`id_disciplina` ASC),
  INDEX `fk_pre_requisitos_2_idx` (`id_disciplina_pre_requisito` ASC),
  CONSTRAINT `fk_pre_requisitos_1`
    FOREIGN KEY (`id_disciplina`)
    REFERENCES `canudosway`.`disciplina` (`id_disciplina`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_pre_requisitos_2`
    FOREIGN KEY (`id_disciplina_pre_requisito`)
    REFERENCES `canudosway`.`disciplina` (`id_disciplina`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
